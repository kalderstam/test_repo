...
Check for aproject in gitlab.com/{group}.
If your project is not set please add it:

- Create a new project on `gitlab.com/{group}/aproject`
- Then populate it:

  $ ##   e.g. if group is "{group}" and project_name is "aproject"
  $ git remote add origin git@gitlab.com:{group}/aproject.git
...
Install
==========
Go to `gitlab.com/{group}/aproject` to see the project, manage issues,
